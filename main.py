...
# List of students to notify
students = [
    {"Name": "Amit", "Email": "projita2003kar@gmail.com", "Status": "Selected"},
    {"Name": "Priya", "Email": "projita2003kar@gmail.com", "Status": "Documents Missing"},
    {"Name": "Rahul", "Email": "projita2003kar@gmail.com", "Status": "Loan Approved"}
]

# Create Crew with parallel execution
crew = Crew(agents=[student_counselor], tasks=[student_counseling_task], process="sequential",verbose=True)

# Run CrewAI for all students
for student in students:
    content=crew.kickoff(inputs={"student": student["Name"], "status": student["Status"],"email": student["Email"]})
    send_email(student["Email"], f"Admission Status Update: {student['Status']}", str(content))